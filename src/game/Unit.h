...
enum SpellAuraInterruptFlags
{
    ...
    AURA_INTERRUPT_FLAG_CAST                        = 0x00000004,   // 2    removed by any spell cast
    ...
    AURA_INTERRUPT_FLAG_TALK                        = 0x00000400,   // 10   removed by gossip &| object interaction
    AURA_INTERRUPT_FLAG_USE                         = 0x00000800,   // 11   mine/use/open action on gameobject
    AURA_INTERRUPT_FLAG_MELEE_ATTACK                = 0x00001000,   // 12   removed by any melee attack
    AURA_INTERRUPT_FLAG_SPELL_ATTACK                = 0x00002000,   // 13   removed by any spell attack
    AURA_INTERRUPT_FLAG_UNK14                       = 0x00004000,   // 14
    AURA_INTERRUPT_FLAG_TRANSFORM                   = 0x00008000,   // 15   removed by cast transform spells
    ...
    AURA_INTERRUPT_FLAG_TELEPORTED                  = 0x00400000,   // 22   removed by any teleport / relocation
