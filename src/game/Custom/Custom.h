...
{
    CUSTOMCONFIG_FLOAT_STATS_LIMITS_DODGE,
    CUSTOMCONFIG_FLOAT_STATS_LIMITS_PARRY,
    CUSTOMCONFIG_FLOAT_STATS_LIMITS_BLOCK,
    CUSTOMCONFIG_FLOAT_STATS_LIMITS_CRIT,
    CUSTOMCONFIG_FLOAT_VALUE_COUNT
};

enum CustomConfigBoolValues
{
    CUSTOMCONFIG_BOOL_STATS_LIMITS_ENABLE,
